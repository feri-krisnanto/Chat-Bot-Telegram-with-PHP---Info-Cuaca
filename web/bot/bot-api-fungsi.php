...
function sendApiPhoto($chatid, $photo, $msg_reply_id = false)
{
    $method = 'sendPhoto';
    $data = [
        'chat_id'  => $chatid,
...
function sendApiVideo($chatid, $video, $msg_reply_id = false)
{
    $method = 'sendVideo';
    $data = [
        'chat_id'  => $chatid,
...
function sendApiLocation($chatid, $lang,$lat, $msg_reply_id = false)
{
    $method = 'sendLocation';
    $data = [
        'chat_id'  => $chatid,
